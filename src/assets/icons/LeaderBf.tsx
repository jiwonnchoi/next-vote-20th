...
const SvgLeaderBf = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path stroke="#E3E8F5" strokeWidth={3} d="M170.5 14.5h105v62h-105z" />
    <g filter="url(#Leader_bf_svg__a)">
      <ellipse
        cx={119.5}
        cy={85}
        stroke="#F9FAFB"
    ...
    <defs>
      ...
      >
        ...
        <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_82_32" />
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_82_32"
          result="shape"
        />
      </filter>
    </defs>
