  ...
  return (
    <>
      ...
      >
        ...
        <Star className="absolute pc:w-28 w-24 pc:top-48 top-52 left-6 pc:-left-3 twinkle" />
        <StarRed className="absolute pc:w-20 w-16 top-12 pc:-right-5 right-3 twinkle-reverse" />
