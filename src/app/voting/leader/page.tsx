...
export default function LeaderVoting() {
  ...
  return (
    <>
      <div className="relative w-[17.5rem] ml-[8%] mb-4 scale-100 pc:scale-150 pc:self-center pc:mr-[35%] pc:mt-7">
      ...
      <div className="self-end grid grid-cols-2 gap-x-4 gap-y-8 mr-[13%] scale-100 pc:scale-150 pc:self-center pc:ml-[55%] pc:mt-11">
